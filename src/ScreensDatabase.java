...
public class ScreensDatabase {
    ...
    public ScreensDatabase(){
        ...
        this.screen2 = new Screen(List.of(new Entry(null, "ASSETS", this.screen1)));
        this.screen3 = new Screen(List.of(new Entry(null, "EMAIL", this.screen1)));
        this.screen4 = new Screen(List.of(new Entry(null, "DATABASES", this.screen1)));
        ...
        this.screen1.getSpecificOption(1).setParent(this.screen1);
        this.screen1.getSpecificOption(2).setParent(this.screen1);
        this.screen1.getSpecificOption(3).setParent(this.screen1);
    }
